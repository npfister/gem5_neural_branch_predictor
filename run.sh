...
./build/ALPHA_MESI_CMP_directory/gem5.debug -d perceptronOut2 configs/spec2k6/run.py -b bzip2 --maxinsts=10000000 --cpu-type=inorder --caches --pred-type="perceptron" --global-hist-size=8 --global-pred-size=4096
